...
@function_tool
def cat_file(
    wrapper: RunContextWrapper[ScriptyContext],
    filepath: str,
    line_start: int = 0,
    line_end: int = 200,
) -> str:
...
@function_tool
def list_files(wrapper: RunContextWrapper[ScriptyContext]) -> List[str]:
    """
...
@function_tool
def run_bash_command(wrapper: RunContextWrapper[ScriptyContext], command: str) -> str:
    """
